        ...
        <section id="home" className="relative px-4 py-20 sm:px-6 lg:px-8 bg-gradient-to-b from-[#E6FFFB] to-[#FFFFFF] pt-[140px]">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col items-center gap-6 max-lg:px-12 max-md:px-2 max-sm:px-0">
                    <div className="flex items-center gap-2 bg-white px-3 py-2 rounded-full border border-gray-200 shadow-sm bg-white" data-aos="fade-up">
                        <i>
                    ...
                    <h1 className="text-5xl md:text-6xl lg:text-7xl max-sm:px-4 font-bold text-center leading-tight text-foreground" data-aos="fade-up">
                        The Safe Space for
                        <br />
                        <span className="text-primary font-extrabold">Every Deal</span>
                    </h1>
                    <div className="w-fit flex flex-col items-center max-md:px-4">
                        <p className="font-semibold max-sm:text-sm text-gray-600 max-w-3xl leading-relaxed text-center" data-aos="fade-up" data-aos-delay="300">
                            Secure escrow payments service for freelance, gig economy, and creator–brand collaboration activities.
                        </p>
                        <p className="text-muted-foreground max-sm:text-sm max-w-3xl leading-relaxed text-center mt-2" data-aos="fade-up" data-aos-delay="300">
                            Transaction are protected by Smart Contracts until all parties deliver their commitments.
                        </p>
                    </div>

                    <div className="flex flex-row gap-4 pt-2" data-aos="fade-up" data-aos-delay="400">
                        <Link href="/dashboard">
