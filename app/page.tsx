...
export default function Home() {
  return (
    <div className="min-h-screen bg-background">
      <LandingNavbar />
      {/* Hero Section */}
      <section className="relative px-4 py-20 sm:px-6 lg:px-8 bg-gradient-to-b from-[#E6FFFB] to-[#FFFFFF] pt-[140px]">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-center gap-6 max-lg:px-12 max-md:px-2 max-sm:px-0">
            ...
            <div className="flex flex-row gap-4 pt-2">
              <Link href="/dashboard">
                <Button size="lg" className="cursor-pointer bg-primary text-primary-foreground hover:bg-primary/90">
                  Get Started <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
              </Link>

              <Button size="lg" variant="outline" className="cursor-pointer hover:bg-primary/10 hover:text-primary hover:border-primary">
                Watch Demo
              </Button>
            </div>
          </div>
